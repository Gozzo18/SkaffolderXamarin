...
namespace angular6.ViewModels.ResourcesViewModel
{
    public class FilmListViewModel : BaseViewModel
    {
        ...
        public ICommand EditFilmCommand
        {
            get
            {
                return new Command(async (e) =>
                {
                    ...
                    await masterDetailPage.Detail.Navigation.PushAsync(new FilmEditLoadingView(film), false);
                });
        ...
        private async Task AddNewFilm()
        {
            ...
            await masterDetailPage.Detail.Navigation.PushAsync(new FilmEditLoadingView(null), false);
